...
class App extends React.Component {
    constructor() {
        ...
        this.handleSearchingChange = this.handleSearchingChange.bind(this);
    ...
    handleDisplayInfo (disInfo) {
        //this.disInfo = disInfo;
        this.setState({disInfo: disInfo});
        //console.log(this.info);
    }

    handleSearchingChange(filteringCon) {
        this.setState({
    ...
    searchColorCards(data, searchWord, searchPrice) {
        return data.filter((item) => {
            ...
            const name = item.brandName + " " + item.colorName;
            return pattern.test(name) && (price < searchPrice);
        });
    };
                ...
                for (let item in response.data) {
                    ...
                    colorValue.map(colorHex => {
                        ...
                        lipArray.push({
                            ...
                            image: response.data[item].api_featured_image,
        ...
        return (
            <div className="row">
                <div className="sideContainer">
                    <InfoBox disInfo={this.state.disInfo} />
                    <FilterForm onSearchingChange={this.handleSearchingChange}/>
                </div>
                <div className="mainContainer">
                    {
                        displayData.map(item => {
                            // return <ColorCard key={item.id} id={item.id} color={item.hexColor} name={item.colorName}/>
                            return <ColorCard datum={item} key={item.id} onDisplayInfo={this.handleDisplayInfo}/>
                        })
                    }
                </div>
            </div>
